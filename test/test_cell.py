...
class TestCell(TestCase):
    ...
    def setUp(self):
        ...
        self.test_address = os.path.abspath('testdata/test1.ods')
        # create library object
        self.test_library = main.Library([self.test_address], True)
    ...
    def test_evaluate(self):
        tests = [
            (self.test_library[self.test_address]['Sheet1']['b2'].content, 'cell1'),
            (self.test_library[self.test_address]['Sheet1']['c2'].content, 'cell2'),
            (self.test_library[self.test_address]['Sheet1']['d2'].content, 'cell1'),
            (self.test_library[self.test_address]['Sheet1']['e2'].content, 'test cell'),
        ]
    ...
    def test_dependencies_returns_cell_dependencies_from_formula_content(self):
        self.assertIn("['('.A1]",
                      self.test_library[self.test_address]['sheet1']['e2'].dependencies)

    def test_dependencies_returns_cell_dependencies_from_script_content(self):
        self.assertIn("cells[a1]",
                      self.test_library[self.test_address]['sheet1']['h2'].dependencies)

    def test_cell_can_store_and_return_values(self):
        testing_cell = self.test_library[self.test_address]['sheet1']['h2']
    ...
    def test_cached_value_returns_xml_value_despite_new_value_stored(self):
        testing_cell = self.test_library[self.test_address]['sheet1']['i2']
    ...
    def test_cached_text_returns_xml_text_despite_new_text_stored(self):
        testing_cell = self.test_library[self.test_address]['sheet1']['i1']
    ...
    def test_pyscript_cell_returns_correct_referenced_value(self):
        self.assertEqual('cell1',
                         self.test_library[self.test_address]['sheet1']['h2'].content)
